//
//  ChooseGameVariantCoordinator.swift
//  Game2048
//
...
final class ChooseGameVariantCoordinator: Coordinatable {
    ...
    func start() -> UIViewController {
        ...
        (module.viewModel as? ChooseGameVariantViewModel)?.coordinator = self
        self.module = module
